      ...
      <div>
        ...
        >
          ...
          <el-table-column
            ...
            label="Action">
            <template slot-scope="scope">
              <el-button @click="TodoDeal(scope.row)" type="text" size="small">Details</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      TodoDeal(item = {}) {
        const { taskId } = item;
        this.$store.dispatch('getOne', { params: { taskId }, OpsProcess: false });
