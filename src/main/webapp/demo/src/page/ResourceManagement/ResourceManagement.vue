<template>
  <div style="position: relative;height: 100%">
    ...
    <!--地图上的四个按钮代表的意思标注-->
    <div class="mapicon">
      <div style="display: flex;margin-bottom: 6px;margin-top: 12px;margin-left: 16px">
        <div
      ...
      <div v-for="item in clicktypeInfo" @click="clickType(item)" class="clicktypeItem">
        ...
        <div style="word-break:keep-all;">
          <span style="border:solid 1px;border-radius: 10px;padding:0px 5px;box-sizing: border-box"
                :style="{'color':(item.owner=='ChinaUnicom'?'#E5231E':item.owner=='ChinaTelecom'?'#3166E7':''),'border-color':(item.owner=='ChinaUnicom'?'#E5231E':item.owner=='ChinaTelecom'?'#3166E7':'')}">{{item.owner}}</span>
        </div>
      </div>
      <div v-if="nodata" style="text-align: center;padding: 10px;color: rgba(0,0,0,0.65);font-size: 12px;">noData</div>
    </div>
    <!--资源发布-->
    <div class="add" @click="selectType=true">
            ...
            <div class="information">
              ...
              <input type="text" placeholder="Input here" class="inputs" v-model="resourceId"/>
                ...
                <div class="bmation">
                  ...
                  <span class="item-row posFlex">
                      ...
                      <input type="text" placeholder="Input here" class="inputs" v-model="owner" :disabled="disabled=true"/>
                  </span>
                ...
                <!--<div class="bmation" v-if="capitalCost">-->
                  <!--<span class="item-row">-->
                       <!--<span class="bmationName2">Capital Cost</span>-->
              ...
              <div class="locationInformation">
                ...
                <div class="bmationScond">
                  <span class="item-row" style="margin-right: 7%;">
                    <span class="bmationName2" style="width: 32%;">Longitude</span>
                    <input type="text" placeholder="Input here" class="inputs" v-model="longitude"/>
                  </span>
                  <span class="item-row">
                      <span class="bmationName2" style="width: 29%">Latitude</span>
                      <input type="text" placeholder="Input here" class="inputs" v-model="latitude"/>
                   </span>
                  <div @click="btnIng('add')" type="button" class="selectLaandlo" style="-webkit-appearance:none;">
                    <!--Choose-->
    ...
    <div class="lulu">
      <el-dialog
          ...
          <div class="resourceDetails">
            <div style="display:flex;justify-content: space-between;">
              <div style="display: flex">
                ...
                <div class="detailsMiddle">
                  ...
                  <div style="margin-top: 7px;font-size: 14px;color:rgba(0,0,0,0.45);">
                  ...
                  <div style="display: flex;justify-content: space-between;margin-top: 41px;">
                    ...
                    <div class="typestyleN">
                      ...
                      <div v-if="resdetails.importance==1" class="typeStyle">In</div>
              ...
              <div style="border-bottom: solid 1px #E9E9E9">
                ...
                <div class="basicInfor" style="margin-top: 26px">
                  ...
                  <div>
                    ...
                    <span v-if="resdetails.importance==1" class="titlecolorStyle">In</span>
            ...
            <div class="divTab" v-show="nowIndex===2">
               <div style="display: flex;margin-top: 30px" v-for="item in reportRes">
                 ...
                 <div style="margin-left: 20px;border-bottom: solid 1px #E9E9E9;">
                   <div style="display: flex;justify-content: space-between">
        ...
        <el-button @click="resourceDetailsapply()" v-if="applybtn">ResourceApplication</el-button>
        <el-button @click="resourceTerminationdiv()" v-if="terminationbtn">ResourceTermination</el-button>
            ...
            <div class="information">
              ...
              <div class="basicInformation">
                ...
                <div class="bmation">
                  <div class="item-row">
                    ...
                    <select id="typeStatus2" v-model="statusedit">
                      <option value="" selected disabled>Choose</option>
                      <option value="0">Running</option>
                      <option value="2">Planning</option>
                      <option value="1">Constructing</option>
              ...
              <div class="locationInformation">
                ...
                <div class="bmationScond">
                  ...
                  <div @click="btnIng('edit')" type="button" class="selectLaandlo" style="-webkit-appearance:none;">
                    <!--Choose-->
                    <img src="../../assets/position.png" style="width: 21px;height: 21px"/>
                  </div>
                </div>
      ...
      <el-dialog
        ...
        <div style="margin-top: 30px;margin-left: 50px">
              ...
              <div v-if="show" :class="{positionTop:positionTop}" class="agm-datepicker-wrap">
                <div class="agm-datepicker-header" @click.stop="">
                  ...
                  <span class="agm-datepicker-header-btn-day">
                    <span class="agm-datepicker-header-btn" @click.stop="openSelectYear">{{ select.year }}年 </span>
                    <span class="agm-datepicker-header-btn" @click.stop="openSelectMonth">{{ select.month }}月</span>
                  </span>
          ...
          <div style="display: flex;position: relative;margin-top: 20px;">
            ...
            <textarea style="width: 80%;height: 200px;outline: none" v-model="applyopinion"></textarea>
          </div>
        </div>
        <span slot="footer" class="dialog-footer">
      ...
      <el-dialog
        ...
        <div style="margin-top: 30px;margin-left: 50px">
          ...
          <div style="display: flex;position: relative;margin-top: 20px;">
            <div class="sharingDate" style="width: 15%">Termination reason</div>
            <textarea style="width: 80%;height: 200px;outline: none" v-model="applyopinionmination"></textarea>
          </div>
        </div>
        <span slot="footer" class="dialog-footer">
  ...
  export default {
    ...
    data() {
      return {
        ...
        application: false,
        tabsParam: ['Resource Info', 'Resource Photos',"Service Evaluation"],//（这个也可以用对象key，value来实现）
    ...
    methods: {
      ...
      handOk() {
        ...
        if (flag) {
          ...
          api.create(ResDetail, 'post').then(result => {
            ...
            var icon = new BMap.Icon(require("../../assets/" + imgArr[result['status']]), new BMap.Size(30, 30), {imageSize: new BMap.Size(32, 32)});
      ...
      details(resourceId) {
        ...
        api.getDetail(params).then(result => {
          ...
          api.haveApplied(params).then(result => {
            //判断按钮显示隐藏
            var usenamedetails=JSON.parse(localStorage.getItem('user_info'));
            if(usenamedetails.userName == result.owner){
              console.log(result)
      ...
      baiduMap(result) {
        ...
        for (let i = 0; i < result.length; i++) {
          ...
          var icon = new BMap.Icon(require("../../assets/" + imgArr[result[i]['status']]), new BMap.Size(30, 30), {imageSize: new BMap.Size(32, 32)});
        ...
        mkr.addEventListener("click", function (e) {
          ...
          api.getOne(getOne).then(result => {
            ...
            var item = "<div id='info-item'>" +
              ...
              "<button type='button' id='btn" + result['resourceId'] + "' " + "style='width: 74px;height: 32px;background:rgba(80,105,228,1);border-radius:2px;color: white;text-align: center;line-height: 32px;margin-top: 20px'>Details</button>" +
              "</div>";
