<template>
  <div>
    ...
    <div class="lulu">
      <el-dialog
        :visible.sync="ResourceDialogVisibledat"
        v-if='ResourceDialogVisibledat'
        width="80%"
                ...
                <div class="detailsMiddle">
                  ...
                  <div style="margin-top: 7px;display: flex;justify-content: space-between;">
                    ...
                    <div v-if="dayResource">
                      ...
                      <p v-if="timeBtn">{{day}}day {{hour}}：{{min}}：{{second}}</p>
...
<!--        <el-button @click="resourceInvestmentClick()" v-if="investment">ApplicationForInvestment</el-button>-->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState(['ResourceDialogVisibledat', 'ResourceDialogId']),
    },
    //日历
    filters: {
      // 日期格式过滤器
    ...
    watch: {
      ...
      'ResourceDialogVisibledat': function () {
        this.api();
        this.usernameYes();
        this.details();
      }
    ...
    methods: {
      ...
      //查看详情页面
      details(resourceId = this.ResourceDialogId) {
      ...
      handleClosedat(done) {
        ...
        this.$store.commit('RESOURCE_DIALOG_VISIBLEADAT');
      },
      handleClosemod(done) {
